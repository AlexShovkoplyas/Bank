...
namespace DAL.Write
{
    class RepositoryRavenDb : IRepository
    {
        ...
        public Task<TAggregate> GetById<TAggregate>(string id) where TAggregate : IAgregate, new()
        {
        ...
        public Task SaveAsync(IEnumerable<IAgregate> aggregate, int expectedVersion, params KeyValuePair<string, string>[] extraHeaders)
        {
            throw new NotImplementedException();
        }
    }
